...
// Setup page.
$PAGE->set_url('/local/flexdates_dashboard/trackcourse.php', array('id'=>$id));
$PAGE->set_pagelayout('admin');

// Check permissions.
$coursecontext = context_course::instance($course->id);
require_capability('local/flexdates_dashboard:modify', $coursecontext);


// Creating form instance, passed course id as parameter to action url.
$baseurl = new moodle_url('/local/flexdates_dashboard/trackcourse.php', array('id' => $id));
...
if ($mform->is_cancelled()) {
    ...
    $PAGE->set_title($course->shortname .': '. get_string('trackcourse', 'local_flexdates_dashboard'));
